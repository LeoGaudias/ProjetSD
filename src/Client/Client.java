...
public class Client extends UnicastRemoteObject implements CallBackClient
{
	...
	ArrayList<Homme> classement() // � modifier pour prendre en compte la collision
	{
		ArrayList<Homme> res=new ArrayList<Homme>();
	...
	void reproduction()
	{
		...
		try 
		{
			...
			// r�ception du serveur des meilleurs des autres clients
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			// L'interface peut peut �tre suffir au lieu d'envoyer tout l'objet client
			 ...
			 *  puis trait� ces donn�es, je ne sais pas si la fonction est faite ou non
			 * }
			 * 
			*/
